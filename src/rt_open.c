...
void		rt_read_whitespace(t_rtparser *parser)
{
	char	*file;
...
static char	*rt_read_object(t_rtv1 *rtv1, t_rtparser *parser, t_geom shape)
{
	char		*error;
	t_object	object;
...
static char	*rt_read_light(t_rtv1 *rtv1, t_rtparser *parser)
{
	char		*error;
	t_light		light;
...
static char	*rt_read_command(t_rtv1 *rtv1, t_rtparser *parser, char *label)
{
	t_geom	shape;
...
char		*rt_read_file(t_rtv1 *rtv1, t_rtparser *parser, int fd)
{
	char	*label;
	char	*error;
